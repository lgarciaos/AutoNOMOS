...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eduardo/Robotica/AutoNOMOS2/line_det/install/${idir}'.  Ask the maintainer 'jbohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eduardo/Robotica/AutoNOMOS2/line_det/install/lib;/opt/ros/indigo/lib)
