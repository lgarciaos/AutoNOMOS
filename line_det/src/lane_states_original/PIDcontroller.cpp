...
geometrymsgs::Twist targetposition;
...
void get_path(const std_msgs::Float32MultiArray& path){
...
int main(int argc, char** argv){
	...
	ros::Subscriber sub_path = nh.subscribe("/points/ransac_left",1, get_path);
