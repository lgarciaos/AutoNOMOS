...
std_msgs::Float64MultiArray dirt_ros_t::get_vector_path()
{
...
std_msgs::Float64MultiArray dirt_ros_t::get_vector_tree()
{
  create_floatmultiarray_tree(root);
  return tree_floatmultiarray;
}

void dirt_ros_t::create_floatmultiarray_tree(tree_node_t* node)
{
...
void dirt_ros_t::dealloc_metric()
{

}

void dirt_ros_t::dealloc_tree_aux(tree_node_t* node)
{
